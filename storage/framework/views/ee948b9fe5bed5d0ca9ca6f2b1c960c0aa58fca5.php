        ...
        <div class="content mt-3">
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($facility->message); ?></td>
                                            <td><?php echo e($facility->created_at); ?></td>
                                            <td><?php echo e($facility->updated_at); ?></td>
                                            <td>
                                                <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-primary mb-1" data-toggle="modal"
                                                        data-target="#viewModal-<?php echo e($facility->id); ?>">
                                                    <i class="fa fa-eye"></i>
                                                </button>

                                                <button type="button" class="btn btn-secondary mb-1" data-toggle="modal"
                                                        data-target="#editModal-<?php echo e($facility->id); ?>">
                                                    <i class="fa fa-pencil"></i>
                                                </button>
                                                <button type="button" class="btn btn-danger mb-1" data-toggle="modal"
                                                        data-target="#deleteModal-<?php echo e($facility->id); ?>">
            ...
            <div class="animated">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo e(route('admin.facilities.store')); ?>" method="post" id="createCategory" enctype="multipart/form-data" class="form-horizontal">
                                    <?php echo csrf_field(); ?>
                ...
                <?php $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="modal fade" id="viewModal-<?php echo e($facility->id); ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
                         data-backdrop="static" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <p class="form-control-static"><?php echo e($facility->title); ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <p class="form-control-static"><?php echo e($facility->created_at); ?></p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <p class="form-control-static"><?php echo e($facility->updated_at); ?></p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <p class="form-control-static"><?php echo e($facility->message); ?></p>
                                                </div>
                                            </div>
                    ...
                    <div class="modal fade" id="editModal-<?php echo e($facility->id); ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
                         data-backdrop="static" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo e(route('admin.facilities.update', $facility->id)); ?>" method="post" id="editcategory-<?php echo e($facility->id); ?>" enctype="multipart/form-data" class="form-horizontal">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Title</label></div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="name" name="title" placeholder="Text" class="form-control" value="<?php echo e($facility->title); ?>">
                                                <small class="form-text text-muted">This is a help text</small>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Message</label></div>
                                            <div class="col-12 col-md-9"><textarea name="message" id="textarea-input" rows="9" placeholder="Content..." class="form-control"><?php echo e($facility->message); ?></textarea></div>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-md" onclick="event.preventDefault();
                                            document.getElementById('editcategory-<?php echo e($facility->id); ?>').submit();">
                                            <i class="fa fa-dot-circle-o"></i> Submit
                                        </button>
                                    </form>
                                </div>
                    ...
                    <div class="modal fade" id="deleteModal-<?php echo e($facility->id); ?>" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel"
                         data-backdrop="static" aria-hidden="true" style="display: none;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-danger" onclick="event.preventDefault();
                                        document.getElementById('deletecategory-<?php echo e($facility->id); ?>').submit();">Confirm</button>
                                    <form action="<?php echo e(route('admin.facilities.destroy', $facility->id)); ?>" style="display: none" id="deletecategory-<?php echo e($facility->id); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\event\resources\views/admin/facilities/index.blade.php ENDPATH**/ ?>